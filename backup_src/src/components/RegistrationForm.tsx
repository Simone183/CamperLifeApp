...
export default function RegistrationForm({ onBack, onSuccess, onSwitchToLogin }: RegistrationFormProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm max-w-sm mx-auto">
        <h2 className="text-xl font-black text-slate-900 mb-6 text-center">Registrati a CamperLife</h2>
