...
export const EXAMPLE_TRIP: Trip = {
  ...
  status: "Completato",
  expenses: [
    { id: "te1", title: "Gasolio Eni Siena", amount: 55.0, category: "Carburante", date: "2025-10-10", liters: 30, pricePerLiter: 1.833, odometer: 124500, fuelCompany: "Eni" },
    { id: "te2", title: "Sosta Pienza comunale", amount: 12.0, category: "Sosta", date: "2025-10-11" },
    { id: "te3", title: "Pranzo Tipico Trattoria", amount: 48.0, category: "Cibo", date: "2025-10-11" }
  ],
  photos: [
    {
      id: "tp1",
      url: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&q=80&w=600",
      description: "Il nostro amato camper immerso nell'abbraccio dorato dei cipressi toscani.",
      date: "2025-10-11",
